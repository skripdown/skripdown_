        ...
        for (let i = 0; i < raw.length; i++) {
            if ((result = synt_meta.exec(raw[i])) != null) {
                ...
                if (result[1] === '#') {
                    ...
                    markup = '<div id="##REP-ID##" class="sub-1 sub">'+result[2]+'</div>';
                }
                else if (result[1] === '#2') {
                    reg_sub_level.push(2);
                    markup = '<div id="##REP-ID##" class="sub-2 sub">'+result[2]+'</div>';
                }
                else if (result[1] === '#3') {
                    reg_sub_level.push(3);
                    markup = '<div id="##REP-ID##" class="sub-3 sub">'+result[2]+'</div>';
                }
                else if (result[1] === '#4') {
                    reg_sub_level.push(4);
                    markup = '<div id="##REP-ID##" class="sub-4 sub">'+result[2]+'</div>';
                }
                else if (result[1] === '#5') {
                    reg_sub_level.push(5);
                    markup = '<div id="##REP-ID##" class="sub-5 sub">'+result[2]+'</div>';
                }
                else {
                    reg_sub_level.push(6);
                    markup = '<div id="##REP-ID##" class="sub-6 sub">'+result[2]+'</div>';
                }
                ...
                markup = '<div id="##REP-ID##" class="image">'
                    ...
                    + '<div class="image-dsc">'+result[2]+'</div></div>';
                reg_img_html.push(markup);
                reg_img_value.push(result[2]);
                pattern.push('3');
            }
                ...
                if (result[1] === '1. ') {
                    markup = '<div class="ls-num">'+result[2]+'</div>';
                    while (i+1 < raw.length && (result = /^1\. ([\w\S][\w\S ]*)$/m.exec(raw[i+1])) != null) {
                        markup += '<div class="ls-num">'+result[1]+'</div>';
                        i++;
                    }
                    markup += '<span class="reset-num-ls"></span>';
                }
                else if (result[1] === 'a) ') {
                    markup = '<div class="ls-alpha">'+result[2]+'</div>';
                    while (i+1 < raw.length && (result = /^[ ]*a\) [ ]*([\w,. )(</>]+)$/m.exec(raw[i+1])) != null) {
                        markup += '<div class="ls-alpha">'+result[1]+'</div>';
                        i++;
                    }
                    markup += '<span class="reset-alpha-ls"></span>';
                }
                else if (result[1] === '> ') {
                    markup = '<div class="ls-arrow">'+result[2]+'</div>';
                    while (i+1 < raw.length && (result = /^[ ]*> [ ]*([\w,. )(</>]+)$/m.exec(raw[i+1])) != null) {
                        markup += '<div class="ls-arrow">'+result[1]+'</div>';
                        i++;
                    }
                }
                else if (result[1] === '* ') {
                    markup = '<div class="ls-dot">'+result[2]+'</div>';
                    while (i+1 < raw.length && (result = /^[ ]*\* [ ]*([\w,. )(</>]+)$/m.exec(raw[i+1])) != null) {
                        markup += '<div class="ls-dot">'+result[1]+'</div>';
                        i++;
                    }
                }
                else {
                    markup = '<div class="ls-dash">'+result[2]+'</div>';
                    while (i+1 < raw.length && (result = /^[ ]- [ ]*([\w,. )(</>]+)$/m.exec(raw[i+1])) != null) {
                        markup += '<div class="ls-dash">'+result[1]+'</div>';
                        i++;
                    }
                }
...
function factory(type, data) {
    ...
    function cover(data) {
        return '<div id="cover" class="reset-head-count">'
            ...
            + '<span>'+data[0]+'</span><br>'
            + '<span>'+data[1]+'</span><br>'
            + '<span>bidang minat '+data[4]+'</span><br></div><div id="cov-footer">'
